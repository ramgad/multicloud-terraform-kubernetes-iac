...
module "eks" {
  ...
  manage_aws_auth  = true
   ...
   node_groups = {
      eks_nodes = {
         ...
         ami_id               = data.aws_ami.SpearAhead_ami.id
         instance_types       = [ var.ec2_instance_type, ]
         key_name             = var.SpearAhead_aws_keypair
  ...
  tags = {
    ...
    GitRepo = "https://github.com/ramgad/multicloud-terraform-kubernetes-iac"
    Reason = "SpearAhead-eksproject-example"
