# Step by Step Guide to install Azure AKS with k8sproject
...
~/ramgad/multicloud-terraform-kubernetes-iac/terraform-live/gcloud/rgdev/us-west2 (master) :az version                                                             ✱
{
  "azure-cli": "2.32.0",
...
~/SpearAhead/terraform-iac/scripts [master*] :./setup_env.sh help 
...
This completes the creation of AKS cluster with k8sproject, and the output of cluster name is generated.
