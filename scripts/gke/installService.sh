...
#cat ../../../../manifests/k8sproject-gke/1-px-operator.yml | \
#cat ../../../../manifests/k8sproject-gke/2-storage-cluster.yml | \
cp -f ../../../../manifests/k8sproject-gke/1-px-operator.yml ${vTmpPXOperator};
cp -f ../../../../manifests/k8sproject-gke/2-storage-cluster.yml ${vTmpPXStorage};
