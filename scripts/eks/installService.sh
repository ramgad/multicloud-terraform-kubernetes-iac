...
cp -f ../../../../manifests/k8sproject-eks/0-aws-access-secret.yml ${vTmpAccfile};
...
cp -f ../../../../manifests/k8sproject-eks/1-px-operator.yml ${vTmpPXOperator};
cp -f ../../../../manifests/k8sproject-eks/2-storage-cluster.yml ${vTmpPXStorage};
